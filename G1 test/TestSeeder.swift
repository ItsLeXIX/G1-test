...
struct TestSeeder {
    ...
    static func seedIfNeeded(context: NSManagedObjectContext) {
        ...
        // --- Reset Persian Test 9: delete any existing 261...280 to avoid stale data ---
        do {
            let fetch9: NSFetchRequest<Question> = Question.fetchRequest()
            fetch9.predicate = NSPredicate(format: "id >= %d AND id <= %d", 261, 280)
            let old9 = try context.fetch(fetch9)
            for obj in old9 { context.delete(obj) }
            if context.hasChanges { try context.save() }
        } catch {
            print("Warning: could not delete old Persian questions (261...280): \(error)")
        }

        // --- Persian Test 9: Signs/Rules (IDs 261...280) ---
        add(261, "اين علامت به چه معناست؟",
            "كار جاده اى درپیش است،",
            "يک نفر كنترل ترافيک جلوتر است،",
            "يک گروه بررسی در جاده پيش رو مشغول كار هستند.",
            "مراقب عابران پياده باشيد و آماده باشيد كه جاده را با آنها به اشتراک بگذاريد.",
            "C", "علائم")

        add(262, "اين تابلوى راه به چه معناست؟",
            "اتوبوس هاى مدرسه بدون استفاده از چراغ قرمز چشمک زن يا بازوى توقف در اين منطقه سوار يا پیاده مى كنند.",
            "اتوبوس هاى مدرسه با روشن كردن چراغ هاى قرمز چشمک زن و باز كردن بازوى توقف در اين منطقه سوار يا پیاده مى كنند.",
            "فقط اتوبوس مدرسه در این مکان می‌تواند تردد کند.",
            "ميتوانيد اينجا پارک كنيد.",
            "A", "علائم")

        add(263, "اين راننده از سيگنال دستی استفاده مى كند. راننده قصد دارد",
            "به سمت چپ برود ، به سمت چپ دور بزند .",
            "قصد كاهش سرعت يا توقف .",
            "سرعت دادن به خودرو .",
            "به سمت راست برود ، به سمت راست دور بزند .",
            "B", "علائم")

        add(264, "اين تابلوى راه به چه معناست؟",
            "یک مسير انحرافى در پیش است .",
            "خطر! پيچ تيز در پيش است.",
            "يك زمين بازى در سمت راست وجود دارد.",
            "خطر! جاده جلوتر به پايان مى رسد .",
            "B", "علائم")

        add(265, "اين علامت به چه معناست؟",
            "پيچ يا خم ملايمى در جاده پيش رو وجود دارد.",
            "در سمت راستِ جزيره ترافيكى حركت كنيد.",
            "جاده در جلو منشعب مى شود.",
            "يك لاين سبقت در جلو وجود دارد.",
            "D", "علائم")

        add(266, "اين تابلوى راه به چه معناست؟",
            "خط چپ جلوتر به پايان مى رسد",
            "خط راست جلوتر به پايان مى رسد",
            "خط سرعت جلوتر",
            "گذركاه باريكى در پيش رو است",
            "B", "علائم")

        add(267, "اين علامت به چه معناست؟",
            "در این محدوده، وسایل نقلیه اجازه ندارند وارد خط HOV شوند یا از آن خارج شوند.",
            "اين یک مسیر عابر پياده است.",
            "يک‌گذرگاه راه آهن جلوتر است.",
            "نزدیک به لبه جاده خطرى وجود دارد.",
            "A", "علائم")

        add(268, "اين تابلوى راه به چه معناست؟",
            "حداكثر سرعت مطمئن در سطح شيب دار",
            "تغيير محدوديت سرعت در پيش است",
            "حداكثر سرعت مجاز در بزرگراه",
            "حداكثر سرعت مطمئن براى پیچ",
            "C", "علائم")

        add(269, "اين علامت به چه معناست؟",
            "بايستيد و به وسايل نقليه نزدیک تسليم شويد.",
            "سرعت خود را كاهش دهيد وبه وسايل نقليه نزديک تسليم شويد.",
            "سرعت خود را کم کنید و سپس ادامه دهید .",
            "سرعت خود راكم كنيد و با احتياط ادامه دهيد.",
            "A", "علائم")

        add(270, "اين علامت به چه معناست؟",
            "به جز در زمان هاى نشان داده شده از چرخش و دورزدن خوددارى كنيد.",
            "به چپ نپیچید",
            "به جز در زمان هاى نشان داده شده به چپ نپیچيد.",
            "در زمان هاى نشان داده شده به چپ نپیچید",
            "D", "علائم")

        add(271, "اين علامت به چه معناست؟",
            "ترافيک بايد فقط دريك جهت حركت كند.",
            "سمت راست جزيره ترافيکی نگه داريد.",
            "یک پيج يا پیچ های شديد در جاده پيش رو وجود دارد.",
            "وسايل نقليه در اين خط بايد به راست بپيچند.",
            "A", "علائم")

        add(272, "اين تابلوى راه به چه معناست؟",
            "هيچ كدام از موارد بالا",
            "جاده‌ی شنی پيش رو است",
            "تقاطع با پل جلوتر",
            "سطح سنگفرش شده يا شياردار جلوتر است",
            "D", "علائم")

        add(273, "يک جفت از اين نشانه ها به چه معناست؟",
            "در ناحيه بين علائم توقف نكنيد.",
            "در محدوده بين تابلوها توقف نكنيد مگر براى بارگيرى يا تخليه.",
            "در ناحيه بين تابلوها میتوانید بايستيد.",
            "در قسمت بين تابلوها پارک نكنيد.",
            "A", "علائم")

        add(274, "اين تابلوى راه به چه معناست؟",
            "يک دوربرگردان 300 متر جلوتر است.",
            "يک تقاطع آزادراه 300 متر جلوتر است.",
            "دور زدن 300 متر جلوتر مجاز است.",
            "از چپ برانيد.",
            "A", "علائم")

        add(275, "اين تابلوى راه به چه معناست؟",
            "از چپ برانيد.",
            "در سمت چپ جزيره مركزى بمانيد.",
            "بايد به چپ بپيچيد.",
            "يک منحنی تيز در سمت چپ وجود دارد.",
            "D", "علائم")

        add(276, "اين علامت به چه معناست؟",
            "عبور عابران پياده",
            "منطقه زمين بازى",
            "يك مسير پياده روى",
            "محدوده مدرسه",
        ...
        add(277, "اين علامت به چه معناست؟",
            "جاده به راست ميپيچد",
            "خميدگی يا انحناى ملايم در جاده پيش رو",
            "به سمت راست تسليم شويد",
            "این لاین جلوتر بسته است",
            "D", "علائم")

        add(278, "اين علامت به چه معناست؟",
            "پل باریک یک كيلومتر جلوتر",
            "كار ساخت و ساز یک كيلومتر جلوتر",
            "انحراف یک كيلومتر جلوتر",
            "یک كيلومتر جلوتر فرد كنترل ترافیک وجود دارد.",
            "B", "علائم")

        add(279, "اين چه نوع نشانه اى است؟",
            "علامت قوانین شرط موقت",
            "علامت هشدار دهنده",
            "علامت تنظيمى برای خودرو ها",
            "علامت اطلاعات وجهت",
            "C", "علائم")


        add(280, "اين خط كشى روسازى به چه معناست؟",
            "منحنی تيز در پيش است.",
            "خط HOV از جلو شروع مى شود.",
            "اينجا یک مسير دوچرخه سوارى است.",
            "خط مشترك! تردد وسايل نقليه با دوچرخه در اين خط میباشد.",
            "D", "علائم")

        // --- Reset Persian Test 10: delete any existing 281...300 to avoid stale data ---
        do {
            let fetch10: NSFetchRequest<Question> = Question.fetchRequest()
            fetch10.predicate = NSPredicate(format: "id >= %d AND id <= %d", 281, 300)
            let old10 = try context.fetch(fetch10)
            for obj in old10 { context.delete(obj) }
            if context.hasChanges { try context.save() }
        } catch {
            print("Warning: could not delete old Persian questions (281...300): \(error)")
        }

        // --- Persian Test 10: Rules (IDs 281...300) ---
        add(281, "در حين رانندگى، یک دانش آموز كلاس G1 بايد توسط یک راننده همراه نظارت شود. سطح الكل خون راننده همراه بايد كمتر از",
            "0.08%.",
            "0.5%.",
            "0.05%.",
            "0.02%.",
        ...
        add(282, "دو خودرو همزمان از جهت مخالف به يک تقاطع غير قابل كنترل نزديك مى شوند. يكى در حال برنامه ريزى براى رفتن مستقيم است. دیگری قصد دارد به چپ بپیچد. كدام وسيله نقليه حق تقدم دارد؟",
            "كسی كه مستقيم  می‌رود حق تقدم دارد.",
            "هر دو وسيله نقليه بايد ابتدا توقف كنند و سپس ادامه دهند.",
            "هر دو حق تقدم دارند.",
            "كس كه به چپ مى چرخد حق تقدم دارد.",
            "A", "قوانین رانندگی")

        add(283, "وقتی یک تراموا براى سوار كردن يا پیاده کردن مسافران در جايى كه جزيره ایمنی وجود دارد متوقف مى شود, قانون شمارا ملزم به انجام چه كارى مى كند؟",
            "حداقل دو متر پشت جزيره ايمنی توقف كنيد.",
            "بوق خود را به صدا درآوريد و با احتياط عبور كنيد.",
            "با احتياط عبور كنيد و در صورت حركت ناگهانی يا غير منتظره عابر پياده آماده توقف باشيد.",
            "حداقل دو متر پشت درهاى عقب تراموا بايستيد.",
            "C", "قوانین رانندگی")

        add(284, "اگر براى اولين بار در حالى كه گواهينامه شما تعليق شده است، محكوم به رانندگی بدون گواهینامه شدید ، به جز این که شش ماه دیگر از گواهینامه  محروم خواهيد شد باكدام یک از مجازات هاى اضافى زير روبرو خواهيد شد؟",
            "يا زندان يا جريمه يا هر دو",
            "جريمه اى بين ٢٠٠٠ تا ٠٠٠ه دلار",
            "شش ماه زندان",
            "هیچ کدام ",
            "A", "قوانین رانندگی")

        add(285, "رانندگى با حداكثر سرعت مجاز در شب خطرناک تر از روز است زيرا",
            "در شب نمى توانيد جلوتر را ببينيد.",
            "برخى از رانندگان به طور غيرقانونى فقط با چراغ نور کم رانندگى مي كنند.",
            "جاده ها در شب لغزنده است. ",
            "زمان واكنش شما در شب چهار برابر كندتر است.",
            "A", "قوانین رانندگی")

        add(286, "اگر در هنگام رانندگى در شب با وسيله نقليه اى روبرومى شويد كه چراغ هاى روشن كوركننده دارد، چه بايد بكنيد؟",
            "به چراغ هاى جلوى خودروى نزدیک نگاه كنيد.",
            "به لبه سمت راست جاده نگاه كنيد.",
            "چراغ هاى جلوى خود را روشن كنيد.",
            "چشمان خود را به سرعت باز كرده و ببنديد.",
            "B", "قوانین رانندگی")

        add(287, "اگر راننده اى خروجى خود را در بزرگراه از دست بدهد، چه بايد بكند؟",
            "از خروجى بعدى برويد.",
            "اگر وسيله نقليه ديگرى در اطراف وجود ندارد، دنده عقب بگیرید  .",
            "دور بزن.",
            "روى شانه بايستيد و نقشه خود را بررسی كنيد.",
            "A", "قوانین رانندگی")

        add(288, "اگر دارنده گواهينامه G1 يا G2 در طول دوسال 9 امتياز منفی يا بيشتر جمع آورى كند، گواهينامه اش به مدت….. تعليق خواهد شد.",
            "2 هفته.",
            "2 سال.",
            "60 روز.",
            "1 سال.",
        ...
        add(289, "وقتی در باران شدید، مقدار آب روی جاده آن‌قدر زیاد باشد که لاستیک‌ها نتوانند آب را کنار بزنند، ماشین روی لایه‌ای از آب قرار می‌گیرد و کنترل آن کم می‌شود. به این حالت هیدروپلنینگ گفته می‌شود. برای جلوگیری از این وضعیت چه باید کرد؟",
            "مطمئن شوید تایرها عمق آج کافی دارند.",
            "فشار باد تایرها را همیشه در حد مناسب نگه دارید.",
            "در هنگام رانندگی زیر باران، سرعت خود را کاهش دهید.",
            "همه موارد بالا.",
            "D", "قوانین رانندگی")

        add(290, "شما بايد حداقل ….. فاصله ايمنی از وسيله نقليه جلويى خود حفظ كنيد.",
            "2 ثانيه",
            "3 ثانيه",
            "5 ثانيه",
            "1 ثانيه",
        ...
        add(291, "شما در حال ترک وسيله نقليه خود که در سمت راست خيابان پارک کرده اید هستید و شیب خیابان رو به پايين هست. چه كارى بايد انجام دهيد؟",
            "بايد ترمز دستی خود را چک كنيد و چرخ هاى جلوى خود را به سمت چپ بچرخانيد",
            "یک سنگ زير چرخ ها قرار دهيد",
            "ترمز دستی خود را چک کنید و چرخ هاى جلوى خود را به سمت راست بچرخانيد",
            "ترمز دستی خود را چک کنید چرخ هاى جلوى خود را موازى با خیابان بگذاريد.",
            "C", "قوانین رانندگی")

        add(292, "نمونه هايى از دستگاه هاى هندزفرى ( بدون نیاز به دست )  عبارتند از :",
            "یک دستگاه سيستم موقعيت ياب جهانى (GPS) كه به درستی روى داشبورد يا مكان قابل دسترس ديگرى در خودرو محكم شده است.",
            "یک پخش كننده صوتى قابل حمل كه بايک ليست پخش از پيش تعيين شده به سيستم صوتى خودرو وصل شده است.",
            "تلفن همراه با گوشی يا هدست با استفاده از شماره گيرى صوتى، يا وصل به سيستم صوتى خودرو.",
            "همه موارد فوق",
            "D", "قوانین رانندگی")

        add(293, "شما نمى توانيد در فاصله ….از شير آتش نشانى پارک كنيد.",
            "3 متر",
            "5 متر",
            "6 متر",
            "2 متر",
        ...
        add(294, "اگر ترمزهاى شما خراب شود،",
            "ترمز دستی را به آرامى اما محكم فشار دهيد.",
            "همه موارد بالا را انجام دهيد",
            "فلاشرهاى اضطرارى خود را روشن كنيد",
            "پدال ترمز را پمپ كنيد ",
            "B", "قوانین رانندگی")

        add(295, "وقتی دريک خيابان شلوغ از ماشين خود پياده مى شويد. چه زمانى بايد در را باز كنيد؟",
            "هروقت.",
            "بعد از فرا رسيدن شب",
            "وقتی مطمئن هستيد كه مى توان آن را با خيال راحت انجام داد.",
            "وقتی فلاشرهاى چهار طرفه خود را روشن مى كنيد.",
            "C", "قوانین رانندگی")

        add(296, "اگر برنامه آموزشی رانندگى مورد تأييد دولت را گذرانده ايد وداراى گواهينامه G1 هستيد، حداقل پس از چند ماه بعد از داشتن گواهينامه G1، می‌توانید در آزمون رانندگى G2 شركت كنيد؟",
            "6 ماه.",
            "10 ماه.",
            "12 ماه.",
            "8 ماه.",
        ...
        add(297, "شما دريک جاده دو لاینه هستيد. در مركز جاده یک خط زرد ممتد و یک خط زرد نقطه چين وجود دارد. خط زرد ممتد در سمت شما قرار دارد. كدام يک از جملات زير صحيح است؟",
            "فقط زمانى عبور كنيد كه هيج ترافيكى در ديد نباشد.",
            "عبور از ان در روز امن است.",
            "عبور از آن ناامن است.",
            "عبور از آن امن است.",
            "C", "قوانین رانندگی")

        add(298, "در انتاريو، چه زمانى بايد چراغ هاى جلوى خود را روشن كنيد؟",
            "بين نيم ساعت بعد از غروب آفتاب ونيم ساعت قبل از طلوع خورشيد و در هر زمان ديگرى تا مسافت 150 مترى نمى توانيد به وضوح ببينيد.",
            "بين غروب و طلوع خورشيد و در هر زمان ديگرى نمى توانيد تا فاصله 150 مترى به وضوح ببينيد",
            "بين غروب و سپيده دم و در هر زمان دیگرى تا 150 مترى نمى توانيد به وضوح ببينيد",
            "بين نيم ساعت قبل از غروب آفتاب ونيم ساعت بعد از طلوع خورشيد و در هر زمان ديگرى تا مسافت 150 مترى که نمى توانيد به وضوح ببينيد.",
            "D", "قوانین رانندگی")

        add(299, "در چه صورت بايد تصادف را به پليس گزارش دهيد ؟",
            "هریک از موارد بالا درست است",
            "كسی مجروح شد",
            "خسارت وارده به خودروها اگر بيش از 2000 دلار است.",
            "شما مشكوک هستيد كه فرد مقابل ممكن است مرتكب تخلف رانندگی شده باشد",
            "A", "قوانین رانندگی")

        add(300, "اگر گواهينامه G1 داريد، در چه صورت مى‌توانيد در بزرگراه هاى سرى 400 يا بزرگراه هاى پرسرعت رانندگى كنيد.",
            "در صورت همراهى راننده با 4 سال سابقه رانندگى.",
            "اگر با دقت رانندگى كنيد.  ",
            "زمانى كه فكر مى كنيد تجربه كافى داريد.",
            "هنگامى كه با یک مربى رانندگى همراه هستید. ",
            "D", "قوانین رانندگی")
